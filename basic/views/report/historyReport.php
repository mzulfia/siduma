...
$this->registerJsFile(\Yii::$app->request->baseUrl . 'js/sand-signika.js', ['depends' => [\yii\web\JqueryAsset::className()]]);
                ...
                Highcharts::widget([
                    'options' => [
                        ...
                        'series' => [
                            ...
                            [
                                'name' => 'Tidak', 
                                'data' => [$bad_erp, $bad_email, $bad_ap2t, $bad_p2apst, $bad_bbo, $bad_apkt, $bad_itsm]
                            ],
                        ],
                        'plotOptions' => [
                            'series' => [
